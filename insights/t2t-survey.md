...
> **数据基础**: 本项目收录的 **84** 篇 T2T 安全论文（2022–2026）
> **更新日期**: 2026-04-17
...
大语言模型（LLM）的安全性研究在 2022–2026 年经历了从"偶发性漏洞发现"到"系统化攻防工程"的转变。本 Survey 基于本项目持续收录的 T2T 论文，沿**攻击方法、防御机制、评测基准、Agent 安全**四条主线进行梳理，揭示了越狱攻击从手工设计到 AI 自主发现的四代演进路径，以及防御研究从黑盒对齐转向机制可解释性与表示层控制的范式转变，并对推理链安全、MCP 工具链攻击、边缘端 LLM 等新兴方向给出了系统性展望。
...
截至 2026-04-17，本 Survey 锚定本项目已收录的 **84** 篇 T2T 安全论文。与早期以单轮越狱和静态对齐为主的阶段相比，当前论文库已经明显扩展成四条并行主线：
...
从时间分布看，**2026 年仍是绝对主战场**：大量论文不再满足于“再做一个新 jailbreak”，而是开始研究为什么对齐会失效、验证器如何被黑、以及防御应部署在表示层、规划层还是运行时层。
...
*本 Survey 由 `paper-research` skill 自动生成，基于项目截至 2026-04-17 收录的 T2T 论文（84 篇）。*  
*上次 Survey 更新：2026-04-17（新增 4 篇：2604.12817 ER-CAT、2604.14865 Segment-Level Coherence、2604.14602 CausalDetox、2604.15149 RLVR Reward Hacking）。*  
