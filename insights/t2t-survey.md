...
> **数据基础**: 本项目收录的 **80** 篇 T2T 安全论文（2022–2026）
> **更新日期**: 2026-04-15
...
按时间分布，2026 年论文数量爆发性增长（27/41 篇来自 2026 年），反映了该领域当前的高度活跃状态。
...
*本 Survey 由 `paper-research` skill 自动生成，基于项目截至 2026-04-15 收录的 T2T 论文（80 篇）。*  
*上次 Survey 更新：2026-04-15（新增 2 篇：2604.09748 Backdoors in RLVR（奖励回路后门）, 2604.10403 LIRA（指令表示对齐防御））。*  
