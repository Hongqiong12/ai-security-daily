...
截至 2026-04-20，本 Survey 锚定本项目已收录的 **88** 篇 T2T 安全论文。与早期以单轮越狱和静态对齐为主的阶段相比，当前论文库已经明显扩展成四条并行主线：
...
*本 Survey 由 `paper-research` skill 自动生成，基于项目截至 2026-04-20 收录的 T2T 论文（88 篇）。*  
*上次 Survey 更新：2026-04-20（新增 2 篇：2604.15717 Into the Gray Zone、2604.15780 Pruning Unsafe Tickets）。*  
