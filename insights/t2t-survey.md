...
> **数据基础**: 本项目收录的 **63+** 篇 T2T 安全论文（2022–2026）
> **数据基础**: 本项目收录的 **65+** 篇 T2T 安全论文（2022–2026）
> **更新日期**: 2026-04-14
...
*本 Survey 由 `paper-research` skill 自动生成，基于项目截至 2026-04-14 收录的 T2T 论文（65+ 篇）。*  
*上次 Survey 更新：2026-04-14（新增 2 篇：2604.09544 有害统一机制(权重剪枝因果干预), 2604.09235 Unreal Thinking(CoT劫持两阶段后门)）。*  
