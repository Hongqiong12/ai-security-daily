...
> **版本**: v0.6（增量更新：Plan-RewardBench + GUI Distraction）
> **更新日期**: 2026-04-13
> **覆盖论文数**: 16 篇  
...
*本 Survey 由 paper-research skill Phase 5 生成与维护 | 初始版本：2026-03-30 | v0.6 更新：2026-04-12*
*v0.6 更新说明：新增 Plan-RewardBench、GUI Distraction 论文。*
