...
> **版本**: v0.9（增量更新：PlanGuard 规划一致性验证, ADAM 记忆抽取攻击）
> **更新日期**: 2026-04-15
> **覆盖论文数**: 23 篇  
...
*本 Survey 由 paper-research skill Phase 5 生成与维护 | 初始版本：2026-03-30 | v0.9 更新：2026-04-15*
*v0.9 更新说明：新增 PlanGuard（planning-based consistency verification，72.8%→0% ASR）和 ADAM（adaptive memory extraction，up to 100% ASR），把 Agent 安全进一步推进到“规划一致性验证”和“长期记忆主动抽取”两个新面向。*
