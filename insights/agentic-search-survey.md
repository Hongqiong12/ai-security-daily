...
> **版本**: v1.3（增量更新：HarmfulSkillBench / LogJack）
> **更新日期**: 2026-04-20
> **覆盖论文数**: 29 篇  
...
*本 Survey 由 paper-research skill Phase 5 生成与维护 | 初始版本：2026-03-30 | v1.3 更新：2026-04-20*
*v1.3 更新说明：新增 HarmfulSkillBench 与 LogJack，把 Agentic 安全进一步推进到 harmful skill 生态治理与云日志间接注入这两类现实生产攻击面。*
