...
> **版本**: v0.8（增量更新：BadSkill Model-in-Skill 后门, SIF 语义意图碎片化）
> **更新日期**: 2026-04-14
> **覆盖论文数**: 21 篇  
...
*本 Survey 由 paper-research skill Phase 5 生成与维护 | 初始版本：2026-03-30 | v0.8 更新：2026-04-14*
*v0.8 更新说明：新增 BadSkill (Model-in-Skill 后门, ASR 99.5%, 仅需3%毒化率) 和 SIF (语义意图碎片化编排攻击, 71%违规率), 补充 Agent 攻击面的"权重层"和"组合级"两个新维度。*
