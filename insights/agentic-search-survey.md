...
> **版本**: v0.7（增量更新：ClawGuard + Meerkat + STARS）
> **更新日期**: 2026-04-14
> **覆盖论文数**: 19 篇  
...
*本 Survey 由 paper-research skill Phase 5 生成与维护 | 初始版本：2026-03-30 | v0.7 更新：2026-04-14*
*v0.7 更新说明：新增 Meerkat、ClawGuard、STARS 三篇论文，形成 repository-level auditing → invocation-level audit → tool-call runtime guard 的连续叙事。*
