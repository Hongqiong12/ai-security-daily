...
> **版本**: v1.6（增量更新：Function Hijacking / MCP Pitfall Lab）
> **更新日期**: 2026-04-27
> **覆盖论文数**: 34 篇  
...
*本 Survey 由 paper-research skill Phase 5 生成与维护 | 初始版本：2026-03-30 | v1.6 更新：2026-04-27*
*v1.6 更新说明：新增 Function Hijacking Attacks 与 MCP Pitfall Lab，并把 Agentic 安全继续推进到“tool selection layer 劫持 + protocol-aware trace 审计”这条新的控制面主线。*
