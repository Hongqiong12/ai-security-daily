...
> **版本**: v0.4（增量更新：TraceSafe + SkillTrojan）  
> **更新日期**: 2026-04-10  
> **覆盖论文数**: 11 篇  
...
*本 Survey 由 paper-research skill Phase 5 生成与维护 | 初始版本：2026-03-30 | v0.4 更新：2026-04-10*  
*v0.4 更新说明：确认 TraceSafe + SkillTrojan 收录完整性，补充结构瓶颈分析。*
