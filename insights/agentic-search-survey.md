...
> **版本**: v1.2（增量更新：ATBench-Claw / ATBench-CodeX / DR3-Eval）
> **更新日期**: 2026-04-18
> **覆盖论文数**: 27 篇  
...
*本 Survey 由 paper-research skill Phase 5 生成与维护 | 初始版本：2026-03-30 | v1.2 更新：2026-04-18*
*v1.2 更新说明：新增 ATBench-Claw / ATBench-CodeX 与 DR3-Eval 两篇重点 benchmark，把 Agentic 安全进一步推进到执行环境专用轨迹评测与 Deep Research 可复现评测基础设施。*
