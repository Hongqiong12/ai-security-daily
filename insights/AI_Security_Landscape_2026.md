...
> **数据来源**: 基于本项目收录的 **180 篇** AI 安全论文（2019–2026）系统性分析
> **更新日期**: 2026-04-18（v2.4 增量更新）
...
基于截至 2026-04-18 本项目收录的最新批次论文，可以识别出以下**正在形成的研究热点**：
...
*最近更新：2026-04-18（v2.4 增量更新），累计论文数 **180**（T2T: **86** 篇，T2I: **67** 篇，Agentic Search: **27** 篇）。*
*本次 v2.4 更新：新增 6 篇论文，T2T 补入 Asymmetric Two-Task Unlearning / Context Over Content，T2I 补入 Fragile Reconstruction / T2I-BiasBench，Agentic Search 补入 ATBench-Claw / ATBench-CodeX / DR3-Eval，并同步刷新跨模态“评测系统反身安全化”趋势与图谱统计。*
