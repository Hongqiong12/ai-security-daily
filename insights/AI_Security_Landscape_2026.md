...
> **数据来源**: 基于本项目收录的 **204 篇** AI 安全论文（2019–2026）系统性分析
> **更新日期**: 2026-04-27（v2.8 增量更新）
...
*最近更新：2026-04-27（v2.8 增量更新），累计论文数 **204**（T2T: **94** 篇，T2I: **76** 篇，Agentic Search: **34** 篇）。*
*本次 v2.8 更新：新增 6 篇论文，T2T 补入 AIC / TTI，T2I 补入 PGU / Target-Based Prompting，Agentic Search 补入 Function Hijacking / MCP Pitfall Lab，并新增“控制面安全化”这一跨模态新热点。*
