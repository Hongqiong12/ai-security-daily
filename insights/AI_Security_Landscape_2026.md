...
> **数据来源**: 基于本项目收录的 90+ 篇 AI 安全论文（2019–2026）系统性分析  
> **更新日期**: 2026-04-01  
...
水印攻击：              （新增）SHIFT（2603.29742，无训练轨迹偏转破除）
                       
Benchmark:             GuardT2I  JailbreakBench  MIMMU  PromptSAN
                       BPO-Verify(模型验证 CVPR2026)
...
*最近更新：2026-04-01，累计论文数 90+（T2T: 39 篇，T2I: 48 篇，Agentic Search: 2 篇）。*  
*本次 survey update 新增：T2T +4（Trojan-Speak, GUARD-SLM, LaaJ-SoK, Secure-AI-Agents），T2I +2（Hidden-Ads, SHIFT），Agentic Search +1（Near-Miss）。*  
