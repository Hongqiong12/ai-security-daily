...
> **数据来源**: 基于本项目收录的 **198 篇** AI 安全论文（2019–2026）系统性分析
> **更新日期**: 2026-04-22（v2.7 增量更新）
...
*最近更新：2026-04-22（v2.7 增量更新），累计论文数 **198**（T2T: **92** 篇，T2I: **74** 篇，Agentic Search: **32** 篇）。*
*本次 v2.7 更新：新增 6 篇论文，T2T 补入 HarDBench / IICL，T2I 补入 IncreFA / Embedding Arithmetic / Dual-Guard，Agentic Search 补入 GAAP，并新增“从结果审计走向 provenance / attribution / execution environment 三位一体治理”这一跨模态新热点。*
