...
> **数据来源**: 基于本项目收录的 **192 篇** AI 安全论文（2019–2026）系统性分析
> **更新日期**: 2026-04-21（v2.6 增量更新）
...
基于截至 2026-04-21 本项目收录的最新批次论文，可以识别出以下**正在形成的研究热点**：
...
*最近更新：2026-04-21（v2.6 增量更新），累计论文数 **192**（T2T: **90** 篇，T2I: **71** 篇，Agentic Search: **31** 篇）。*
*本次 v2.6 更新：新增 6 篇论文，T2T 补入 Continual Safety Alignment / Offensive Cyber Benchmark，T2I 补入 Bias at the End of the Score / Operationalizing Fairness in T2I Models，Agentic Search 补入 CASCADE / Visual Inception，并新增“上游控制面安全化”这一跨模态新热点。*
