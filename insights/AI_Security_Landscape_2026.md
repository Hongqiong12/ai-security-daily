...
> **数据来源**: 基于本项目收录的 **174 篇** AI 安全论文（2019–2026）系统性分析
> **更新日期**: 2026-04-17（v2.3 增量更新）
...
*最近更新：2026-04-17（v2.3 增量更新），累计论文数 **174**（T2T: **84** 篇，T2I: **65** 篇，Agentic Search: **25** 篇）。*
*本次 v2.3 更新：新增 12 篇论文，T2T 补入 ER-CAT / Segment-Level Coherence / CausalDetox / RLVR Reward Hacking，T2I 补入 Scaling Exposes the Trigger / QuAD / DAMP，Agentic Search 补入 MemJack / MCPThreatHive / SafeHarness / R2A / CBCL，并同步刷新三模态趋势段落与图谱统计。*
