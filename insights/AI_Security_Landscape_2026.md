...
> **数据来源**: 基于本项目收录的 **186 篇** AI 安全论文（2019–2026）系统性分析
> **更新日期**: 2026-04-20（v2.5 增量更新）
...
*最近更新：2026-04-20（v2.5 增量更新），累计论文数 **186**（T2T: **88** 篇，T2I: **69** 篇，Agentic Search: **29** 篇）。*
*本次 v2.5 更新：新增 6 篇论文，T2T 补入 Into the Gray Zone / Pruning Unsafe Tickets，T2I 补入 TICoE / TwoHamsters，Agentic Search 补入 HarmfulSkillBench / LogJack，并同步刷新“可信载体中的隐式风险组合”这一跨模态新趋势与图谱统计。*
