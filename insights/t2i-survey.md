...
> **数据基础**: 本项目收录的 49 篇 T2I 安全论文（2019–2026）  
> **更新日期**: 2026-04-08  
...
*本 Survey 由 `paper-research` skill 自动生成，基于项目截至 2026-04-08 收录的 T2I 论文（49 篇）。*  
*上次 Survey 更新：2026-04-08（新增 1 篇：2604.05853 Etch 铭文式越狱）。*  
