...
|------|----------|------|----------|------|
| **AR Watermark Robustness** | [2604.11720](https://arxiv.org/abs/2604.11720) | arXiv | 系统揭示自回归图像生成水印在 removal / forgery / radioactive filtering 间存在结构性三难 | [详情](./papers/2604.11720_ar_watermark_robustness.md) |
