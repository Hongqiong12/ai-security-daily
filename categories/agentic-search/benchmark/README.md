# 📊 Agentic Search - 基础评测集

评测 Agentic Search / Coding Agent / Deep Research Agent 能力与安全性的基准测试和诊断框架论文。

> 最后回填: 2026-04-18 | 共 **4** 条

| 论文 | ArXiv | 年份/会议 | 核心创新 |
|------|-------|----------|----------|
| STARS | [2604.10286](https://arxiv.org/abs/2604.10286) | 2026 arXiv | 请求条件化的 skill invocation 连续风险评分，代表 invocation-level auditing |
| Meerkat | [2604.11806](https://arxiv.org/abs/2604.11806) | 2026 arXiv | 把 Agent 安全评测推进到 repository-level witness 搜索与仓库级轨迹审计 |
