...
## 🔥 今日最具破坏力论文评测 (2026-04-08)

> **为什么要关注本仓库？** 每天 08:00，我们的自动化 Agent 会拦截 ArXiv 最新 AI 安全论文，不仅提取摘要，更执行**端到端深度解读（攻击原理、实验复现、防御建议）**。

| 核心威胁领域 | 🚨 破局级论文推荐 | 一句话快评 | 深度拆解 |
|---|---|---|---|
| **Text-to-Text (T2T)** | [InfoFlood：信息过载攻击机制探讨](./categories/t2t/papers/2506.12274_infoflood.md) | 通过海量信息淹没LLM的安全注意力，揭示了长上下文窗口下的新型安全隐患。 | [📄 立即阅读](./daily-reports/t2t/2026-04/2026-04-08_t2t_llm_security.md) |
| **Text-to-Image (T2I)** | [Reason2Attack：LLM推理驱动的越狱](./categories/t2i/papers/2503.17987_reason2attack.md) | 突破传统模版限制，利用推理模型动态生成针对文生图模型的越狱指令。 | [📄 立即阅读](./daily-reports/t2i/2026-04/2026-04-08_t2i_safety.md) |
